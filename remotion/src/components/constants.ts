...
export const SFX_AVAILABLE_FILES: string[] = [
  ...
  'calm-emphasis-medium.mp3',
  'calm-emphasis-strong.mp3',
  'calm-entry-medium.mp3',
  'calm-feedback-medium.mp3',
  'calm-feedback-subtle.mp3',
  'calm-transition-medium.mp3',
  'energetic-ambient-subtle.mp3',
  'energetic-emphasis-medium.mp3',
  'energetic-emphasis-strong.mp3',
  'energetic-entry-medium.mp3',
  'energetic-feedback-medium.mp3',
  'energetic-transition-medium.mp3',
  'energetic-transition-strong.mp3',
  'epic-ambient-subtle.mp3',
  'epic-emphasis-medium.mp3',
  'epic-emphasis-strong.mp3',
  'epic-entry-medium.mp3',
  'epic-exit-medium.mp3',
  'epic-feedback-medium.mp3',
  'epic-transition-medium.mp3',
  'neutral-emphasis-medium.mp3',
  'neutral-emphasis-strong.mp3',
  'neutral-entry-medium.mp3',
  'neutral-feedback-medium.mp3',
  'neutral-feedback-subtle.mp3',
  'neutral-transition-medium.mp3',
  'neutral-transition-strong.mp3',
  'playful-emphasis-medium.mp3',
  'playful-emphasis-strong.mp3',
  'playful-feedback-medium.mp3',
  'playful-feedback-subtle.mp3',
  'playful-transition-medium.mp3',
  'tense-ambient-subtle.mp3',
  'tense-emphasis-medium.mp3',
  'tense-emphasis-strong.mp3',
  'tense-entry-medium.mp3',
  'tense-feedback-medium.mp3',
  'tense-transition-medium.mp3',
]
